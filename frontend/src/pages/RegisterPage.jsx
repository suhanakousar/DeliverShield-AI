...
const RegisterPage = () => {
  ...
  const handleSendOtp = async (e) => {
    e.preventDefault();
    if (!formData.name || !formData.phone || !formData.platform || !formData.delivery_zone || !formData.partner_id) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-base-500 mt-1.5">Type the area where you mostly deliver.</p>
                </div>
